...
public sealed record ProjectOptionEditor(
    ...
    string Label,
    string Description,
    ProjectOptionKind Kind,
    bool IsExplicit,
    string? SelectedCase,
    string? DefaultCase,
    IReadOnlyList<ProjectCaseEditor> Cases,
    IReadOnlyList<ProjectInputEditor> Inputs,
    IReadOnlyList<ProjectOptionEditor> ActiveChildren);

public sealed record ProjectConfigurationView(
    IReadOnlyList<ProjectOptionEditor> GlobalOptions,
    IReadOnlyList<ProjectOptionEditor> TaskOptions);
